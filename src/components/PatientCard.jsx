...
const PatientCard = ({ patient, isOpen, onClose }) => {
  ...
  const handleImageDownload = (imageUrl, patientName) => {
    try {
      ...
      link.href = imageUrl;
      link.download = `${patientName || 'patient'}_image.jpg`;
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">
                {toCamelCase(patient.name) || "Unknown Patient"}
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-300">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-md text-gray-900">{patient.phone?.replace("whatsapp:", "") || "Not Available"}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-300">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-sm text-gray-900">{patient.location || "Not Specified"}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-emerald-50 rounded-lg border border-emerald-300">
                    <Stethoscope className="w-4 h-4 text-emerald-500" />
                    <div>
                      <p className="text-xs text-gray-600 uppercase tracking-wide">Disease</p>
                      <p className="font-medium text-md text-gray-900">{toCamelCase(patient.disease) || "Not Specified"}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-emerald-50 rounded-lg border border-emerald-300">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-sm text-gray-900">{patient.relation || "Not Specified"}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-orange-50 rounded-lg border border-orange-300">
                    ...
                    <p className="font-medium text-sm text-gray-900 leading-relaxed">{patient.reminder_note || "No reminder notes"}</p>
                  </div>
                  <div className="p-3 bg-orange-50 rounded-lg border border-orange-300">
                    <p className="text-xs text-gray-600 uppercase tracking-wide mb-1">Assigned To</p>
                    <p className="font-medium text-sm text-gray-900">{patient.assigned_to?.name || "Not Assigned"}</p>
                  </div>
                  <div className="p-3 bg-orange-50 rounded-lg border border-orange-300">
                    <p className="text-xs text-gray-600 uppercase tracking-wide mb-1">Reminder Date</p>
                    <p className="font-medium text-sm text-gray-900">{patient.reminder_date ? new Date(patient.reminder_date).toLocaleDateString() : "Not Available"}</p>
                  </div>
                  {/* <div className="p-3 bg-orange-50 rounded-lg border border-orange-300">
                    <p className="text-xs text-gray-600 uppercase tracking-wide mb-1">Reminder Type</p>
                    <p className="font-medium text-sm text-gray-900">{patient.reminder_type || "Not Specified"}</p>
                  </div>
                  <div className="p-3 bg-orange-50 rounded-lg border border-orange-300">
                    <p className="text-xs text-gray-600 uppercase tracking-wide mb-1">Conversation ID</p>
                    <p className="font-medium text-sm text-gray-900">{patient.conversation_id || "Not Available"}</p>
                  </div> */}
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg border border-blue-300">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-sm text-gray-900">{patient.visit_date ? new Date(patient.visit_date).toLocaleDateString() : "Not Scheduled"}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg border border-blue-300">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-sm text-gray-900">{patient.visit_time || "Not Scheduled"}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg border border-blue-300">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-sm text-gray-900">{patient.confirmation || "Not Specified"}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="p-4 bg-purple-50 rounded-lg border border-purple-300">
                  {patient.photo_url ? (
                    <div className="space-y-3">
                      <div className="relative group">
                        <img
                          ...
                          onClick={() => handleImageDownload(patient.photo_url, patient.name)}
                          onError={(e) => {
                    ...
                    <div className="text-gray-500 text-center py-8">
                      ...
                      <p className="text-sm text-gray-400">No image attached to this patient</p>
                    </div>
                  )}
                </div>
              </div> */}
